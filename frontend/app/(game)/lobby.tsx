...
const Lobby = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      ...
      <Modal animationIn={"slideInRight"} animationOut={"slideOutRight"} className="flex-1" style={{marginHorizontal: 0, marginBottom: 0}} 
        ...
        <View className="items-start justify-start h-[60px] flex-row p-4 bg-backgroundSecondary">
          <View className="items-start justify-start flex-row">
              <ChevronLeft size={25} color={"white"} onPress={() => {setSuccessMessage(''); setSettingsVisible(false)}}/>
          </View>
        ...
        <View className="w-full h-full items-center pt-20 bg-background">
          ...
          <View className="w-full px-3">
            ...
            <TouchableOpacity className="bg-secondaryText w-full h-[50px] justify-center items-center rounded-xl" 
                              onPress={() => {clickSFX(); setShowWritingPicker(true)}}>
          ...
          <View className="mt-4 w-full px-3">
            ...
            <TouchableOpacity className="bg-secondaryText w-full h-[50px] justify-center items-center rounded-xl" 
                              onPress={() => {clickSFX(); setShowVotingPicker(true)}}>
              <Text style={{fontFamily: 'JetBrainsMonoRegular', fontSize: 18}} numberOfLines={1} adjustsFontSizeToFit={true} 
          ...
          <View className="mt-10 flex w-full flex-row items-center gap-x-3 px-3">
            ...
            <InputSpinner
              ...
              value={maxRounds}
              skin="round"
              onChange={(value: number) => {clickSFX(); setMaxRounds(value)}}
              style={{ flex: 1}}
            />
          </View>
          ...
          <View className="mt-4 flex w-full flex-row items-center gap-x-3 px-3">
            ...
            <InputSpinner
              ...
              value={maxPlayers}
              skin="round"
              onChange={(value: number) => {clickSFX(); setMaxPlayers(value)}}
              style={{ flex: 1 }}
            />
          </View>
      ...
      <View className="items-start justify-between flex-row mt-2 mx-4">
      ...
      <View className="mt-10 self-center">
        ...
        <TouchableOpacity className="mt-2 rounded-full bg-primary px-4 py-2" onPress={() => {clickSFX(); onCodePress()}}>
      ...
      <View className="mx-2 mb-2 flex flex-row justify-between">
        <TouchableOpacity className="bg-secondaryText w-[175px] h-[50px] justify-center items-center rounded-xl"
                                        onPress={() => {clickSFX(); onEditSettingsPress()}}>
